...
SCM_EXPORT double current_gc_start_time;
SCM_EXPORT double gc_cost_time_sum;
SCM_EXPORT char is_exec_cost_time_recoding;
SCM_EXPORT double exec_recoding_start_time;
SCM_EXPORT double exec_recoding_tmp_gc_start_time;
SCM_EXPORT double exec_recoding_gc_cost_time_sum;
