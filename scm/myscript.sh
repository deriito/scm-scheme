...
# ================ Link C object files
mv -f scm scm~
cc -o scm socket.o continue.o scm.o scmmain.o findexec.o script.o time.o repl.o scl.o eval.o sys.o subr.o debug.o unif.o rope.o definedatatype.o ega.o -g -fno-pie
