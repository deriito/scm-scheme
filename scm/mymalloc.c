...
void init_my_zone() {
    ...
    fread(&is_gc_cost_time_recording, sizeof(char), 1, fp);
    fread(&gc_idx_gc_cost_recording_start_at, sizeof(size_t), 1, fp);
    fread(&current_gc_start_time, sizeof(double), 1, fp);
    fread(&gc_cost_time_sum, sizeof(double), 1, fp);
    fread(&is_exec_cost_time_recoding, sizeof(char), 1, fp);
    fread(&exec_recoding_start_time, sizeof(double), 1, fp);
    fread(&exec_recoding_tmp_gc_start_time, sizeof(double), 1, fp);
    fread(&exec_recoding_gc_cost_time_sum, sizeof(double), 1, fp);
